    ...
    countrySelect.addEventListener("change", function () {
      ...
      function generate(countryInfo) {
        for (let i = 0; i < countryInfo.length; i++) {
          ...
          locationText.innerHTML = "location:" + countryInfo[i][1].All.location
          updatedText.innerHTML = "updated:" + countryInfo[i][1].All.updated
          confirmedText.innerHTML = "confirmed:" + countryInfo[i][1].All.confirmed
          populationText.innerHTML = "population:" + countryInfo[i][1].All.population
          deathsText.innerHTML = "deaths:" + countryInfo[i][1].All.deaths
          lifeexpectancyText.innerHTML = "lifeexpectancy:" + countryInfo[i][1].All.life_expectancy
          infectionRateText.innerHTML = "Infection-rate:" + infectionRate+"%"
